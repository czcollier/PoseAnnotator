...
class BboxAnnotator(object):
    def __init__(self, annotations, img_id, img_path, window_name="Image", fps=20, is_start=True) -> None:
        ...
        for annotation in self.annotations:
            ...
            self.stops.append([annotation["bbox"][0]+annotation["bbox"][2], annotation["bbox"][1]+annotation["bbox"][3]])
