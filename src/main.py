...
def parse_args(): 
    ...
    if not (os.path.exists(args.coco_filepath) and os.path.isfile(args.coco_filepath)):
        old_fname = os.path.join("data", args.coco_filepath, "annotations", "person_keypoints_val2017.json")
        new_fname = os.path.join("data", args.coco_filepath, "annotations", "person_keypoints_val2017_new.json")
